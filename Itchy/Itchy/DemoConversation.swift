...
// JSQUser Enum to make it easyier to work with.
enum JSQUser: String {
...
// Helper Function to get JSQUsernames for a secific JSQUser.
func getName(user: JSQUser) -> String{
    switch user {
    case .Squires:
...
let message = JSQMessage(senderId: AvatarIdCook, displayName: getName(JSQUser.Cook), text: "What is this Black Majic?")
let message2 = JSQMessage(senderId: AvatarIDSquires, displayName: getName(JSQUser.Squires), text: "It is simple, elegant, and easy to use. There are super sweet default settings, but you can customize like crazy")
let message3 = JSQMessage(senderId: AvatarIdWoz, displayName: getName(JSQUser.Wazniak), text: "It even has data detectors. You can call me tonight. My cell number is 123-456-7890. My website is www.hexedbits.com.")
let message4 = JSQMessage(senderId: AvatarIdJobs, displayName: getName(JSQUser.Jobs), text: "JSQMessagesViewController is nearly an exact replica of the iOS Messages App. And perhaps, better.")
let message5 = JSQMessage(senderId: AvatarIDLeonard, displayName: getName(JSQUser.Leonard), text: "It is unit-tested, free, open-source, and documented.")


let message6 = JSQMessage(senderId: AvatarIDLeonard, displayName: getName(JSQUser.Leonard), text: "This is incredible")
let message7 = JSQMessage(senderId: AvatarIdWoz, displayName: getName(JSQUser.Wazniak), text: "I would have to agree")
let message8 = JSQMessage(senderId: AvatarIDLeonard, displayName: getName(JSQUser.Leonard), text: "It is unit-tested, free, open-source, and documented like a boss.")
...
let audioMessage = JSQMessage(senderId: AvatarIdWoz, displayName: getName(JSQUser.Wazniak), media: audioItem)
