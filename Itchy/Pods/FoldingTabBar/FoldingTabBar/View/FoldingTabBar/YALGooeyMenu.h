...
@property(nonatomic,assign)UIImage *mainMenuImage;

@property(nonatomic,assign)CGFloat offsetForGooeyMenu;


//添加菜单图标
@property(nonatomic,strong)NSMutableArray *menuImagesArray;

-(id)initWithOrigin:(CGPoint)origin andDiameter:(CGFloat)diameter andDelegate:(UIView *)controller themeColor:(UIColor *)themeColor mainMenuImage:(UIImage *)image;
